...
export default function HabitNav() {
    ...
    <aside className="w-64 border-r border-gray-200 bg-white flex flex-col flex-shrink-0">
      <div className="px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-sm font-semibold text-gray-900">HabitOS</h1>
            <p className="text-[11px] text-gray-400">Build better routines</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {[
          { label: 'Dashboard', href: '/habitos', icon: Grid },
          { label: 'My Habits', href: '/habitos/habits', icon: List },
          { label: 'Calendar', href: '/habitos/calendar', icon: Calendar },
          { label: 'Analytics', href: '/habitos/analytics', icon: Chart },
          { label: 'Settings', href: '/habitos/settings', icon: Settings },
        ].map((item) => {
